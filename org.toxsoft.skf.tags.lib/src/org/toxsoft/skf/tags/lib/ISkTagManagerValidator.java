...
public interface ISkTagManagerValidator {
   ...
   */
  ValidationResult canCreateSection( String aSectionId, IOptionSet aParams );
   ...
   * @throws TsNullArgumentRtException any argument = <code>null</code>
   */
  ValidationResult canEditSection( String aSectionId, IOptionSet aParams );
   ...
   * @throws TsNullArgumentRtException any argument = <code>null</code>
   */
  ValidationResult canCreateTag( ISkTagSection aSection, String aTagId, ESkTagKind aKind, IOptionSet aParams );
   ...
   * @throws TsNullArgumentRtException any argument = <code>null</code>
   */
  ValidationResult canEditTag( ISkTagSection aSection, String aTagId, ESkTagKind aNewKind, IOptionSet aParams );
   ...
   * @throws TsNullArgumentRtException any argument = <code>null</code>
   */
  ValidationResult canRemoveTag( ISkTagSection aSection, String aTagId );
